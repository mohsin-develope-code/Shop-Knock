  ...
  return (
    ...
    <div className='bg-gray-100 w-full py-10'>
        ...
        <form   onSubmit={hanleSubmit}
                className='bg-white mx-auto max-w-[800px] px-14 py-20
           ...
           <div className='flex w-full gap-14'> 
              <div className='flex flex-1 flex-col gap-2'>
                ...
                <input onChange={(e)=> {setFirstName(e.target.value), setErrMessage("")} }
           ...
           <div className='flex w-full gap-14'> 
              ...
              <div className='flex flex-1 flex-col gap-2'>
                ...
                <input onChange={(e)=> setPhone(e.target.value)}
                       type="text" placeholder='6355XXXXX'
                       className='border-2 h-10 px-2 border-gray-300 rounded-md'/>
              </div>
           </div>
           ...
           {
             errMessage ? <div className='text-sm text-center text-red-600 mt-10'>{errMessage}</div> : <></>
           }


            
            <button className='bg-black mt-3 px-14 py-3 rounded-md text-white 
                                 font-medium mx-auto
                                 transition-transform hover:scale-110 hover:ease-in-out'>Create Account</button>

            
            <div className='mx-auto text-sm'>Alrady have an Account? 
